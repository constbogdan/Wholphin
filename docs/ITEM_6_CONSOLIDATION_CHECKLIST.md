...
- [ ] **I06 — IMPLEMENT — Refine Upstream Sync journaling, outcome semantics, and cadence** (Items 23–26, 62–64, 108–119, 128–131, 134, 142, 143)
  ...
  - Offline evidence: all 53 hosted-sync tests pass. They cover three observations reusing one Issue/Draft, unrelated downstream movement, continued same-area upstream movement, priority progression, label replacement/missing labels, clean/attention journal lifecycles, quiet hostile-input Issue/PR surfaces, rich Actions navigation and retained exact artifact provenance, in addition to all prior ownership, conflict, credential, drift and no-force cases.
  - Regression evidence: the complete offline tooling suite passes 157 tests with one existing Windows executable-bit portability skip, preserving I01–I05 classification, delivery, signing, recovery, Stable, validation and updater contracts.
